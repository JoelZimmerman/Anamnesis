...
Download the latest build from [the releases page](https://github.com/JoelZimmerman/Anamnesis/releases), then simply extract it to your location of choice, log in to the game, and run the tool.
